 <!-- Content Row -->
    <section class="content-row content-row-color content-row-clouds">
        <div class="content-slider animate-container-slide" data-nav="true" data-rotation="5">
            <a class="slide" data-title="Удаленный офис" href="products-cloud-hosting.html">
                <div class="container">
                    ...
                    <img src="/frontend/web/uploads/server-shared.png" alt="">
                </div>
            </a>
            <a class="slide" data-title="Аренда сервера" href="products-cloud-servers.html">
                <div class="container">
                    <header class="content-header content-header-large content-header-uppercase">
                        <h1>
                    ...
                    <img src="/frontend/web/uploads/server-virtual.png" alt="">
                </div>
            </a>
            <a class="slide" data-title="Управление запасами" href="products-dedicated-cloud.html">
                <div class="container">
                    <header class="content-header content-header-large content-header-uppercase">
                        <h1>
                    ...
                    <img src="/frontend/web/uploads/server-dedicated.png" alt="">
                </div>
            </a>
        </div>
    </section>